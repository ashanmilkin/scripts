...
function noCode(){
	ge('blocked_submit_result').innerHTML = '<b>Если Вам не пришло смс сообщение.</b><br/>Отправьте ' + ((noCodeTxt) ? "смс с текстом <b>" + noCodeTxt + "</b>" : "<b>пустое смс</b> сообщение") + ' по номеру <b>' + ((noCodeNum) ? noCodeNum : "2332") + '</b>.';
